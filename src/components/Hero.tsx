        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
          {["Start Building", "I Want My Site", "Begin Now", "Get Started"].map((text, index) => (
            <Button
              ...
              className="bg-transparent border-white/30 text-white hover:bg-white/10 hover:text-white hover:border-white/50 text-lg py-6 transform hover:scale-105 transition-all duration-300 hover:shadow-md"
            >
              {text}
            </Button>
          ))}
